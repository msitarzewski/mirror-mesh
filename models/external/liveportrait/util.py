...
#
# Local modifications: none. Unlike FOMM's util.py — where we had to swap
# SynchronizedBatchNorm2d for stock nn.BatchNorm2d so coremltools could
# convert — LivePortrait's util.py already uses stock nn.BatchNorm2d /
# nn.BatchNorm3d / nn.InstanceNorm2d / nn.LayerNorm throughout, all of which
# coremltools 9.0 handles natively. No patching required.
# =============================================================================
