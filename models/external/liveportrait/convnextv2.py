...
#                     Interaction Center
#
# Note: the ConvNeXtV2 architecture itself is © Meta AI Research (Liu et al.,
# 2023) — LivePortrait's authors re-vendored the relevant pieces with their
# own modifications for the motion-extractor head. We pull from LivePortrait
# (MIT) rather than directly from facebookresearch/ConvNeXt-V2 (MIT) so the
# adapted classifier heads (fc_kp / fc_scale / fc_pitch / fc_yaw / fc_roll /
# fc_t / fc_exp) match the LivePortrait checkpoint state-dict shapes byte-for
# byte; the upstream ConvNeXt-V2 file does not contain those heads.
#
...
# preserved in LICENSES/LivePortrait-MIT.txt.
#
